...
import { getMarketingStrategyById } from 'apiSdk/marketing-strategies';
...
function MarketingStrategyViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Marketing Strategy Detail View
          </Text>
          {hasAccess('marketing_strategy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/marketing-strategies/edit/${data?.id}`} passHref legacyBehavior>
              <Button
