    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="design" mb="4" isInvalid={!!formik.errors?.design}>
            <FormLabel>Design</FormLabel>
            <Input type="text" name="design" value={formik.values?.design} onChange={formik.handleChange} />
            {formik.errors.design && <FormErrorMessage>{formik.errors?.design}</FormErrorMessage>}
          </FormControl>
